        ...
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button("Bake"))
            {
                ...
                for (int i = 0; i < serializedObject.targetObjects.Length; i++)
                {
                    ...
                    (serializedObject.targetObjects[i] as ReflectorProbe).RefreshReflection(RefreshMode.Instant);
                }
            }
            ...
            if (GUILayout.Button("Clear"))
            {
                ...
                {
                    //probes[i] = serializedObject.targetObjects[i] as ReflectorProbe;
                    (serializedObject.targetObjects[i] as ReflectorProbe).ResetReflection();
                }
